...
3.  Ajoute une ligne dans `_quarto.yml` pour inclure le fichier dans le site généré :
...
Sert en continu à indiquer à Google quelles pages existent sur mon site, afin d’améliorer le référencement (SEO).
