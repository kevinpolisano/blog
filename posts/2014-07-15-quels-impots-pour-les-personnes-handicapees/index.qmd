...
<a href="https://simulateur-ir-ifi.impots.gouv.fr/calcul_impot/2014/simplifie/index.htm" target="_blank" class="broken_link">--\> Simulateur de l'impôt sur le revenu \<--</a>
...
[Exemple]{style="text-decoration: underline;"} : En 2013, Pierre gagnait le smic, Paul gagnait 1500 € et Jacques gagnait 2000 € net imposable par mois. Quel impôt sur le revenu devront-ils payer en 2014 ?
...
<span style="color: #008000;">[Exemple]{style="text-decoration: underline;"} : Pierre gagne le smic, en <em>net imposable</em> cela représente 1173,38 € par mois d'après mon précédent article [Comprendre son bulletin de paie](../2014-07-06-comprendre-son-bulletin-de-paie)

<p style="text-align: center;">

<span style="color: #008000;"><strong>Revenus que Pierre doit déclarer = 12\*1173,38 = 14080 €</strong></span>
...
Non. Les salaires imposables du point de vue des impôts est le salaire imposable de votre fiche de paie auquel est appliqué un **abattement de 10%** en raison des frais professionnels[^1]. Cet abattement fiscal est au minimum de 421 euros et au maximum de 12 000 €.
...
<strong>[revenu brut de Pierre = 0.9 x 12 x 1173,38 = 0.9 x 14080 = 12672 €]{style="color: #008000;"}</strong>
...
![](images/revenus-brut-deficit.png)
...
-   Déficit foncier (immobilier locatif)
    ...
    -   Pension alimentaire aux descendants majeurs dans la limite de5 698 €par enfant.
...
[<strong>revenu net global imposable de Pierre = 12672 €</strong>]{style="color: #008000;"}
...
![](images/revenus-net-deficit-1.png)
...
[<strong>Quotient familial de Pierre = 12672 €</strong>]{style="color: #008000;"}
...
![](images/tranche-imposition.png)

</p>

<p style="text-align: left;">

[Exemple]{style="text-decoration: underline;"} : Tous les quotients familiaux calculés se situent dans la tranche \[11991,26631\] 

</p>

<p style="text-align: center;">

[<strong>Quotient familial de Pierre = 12672 € --\> TMI = 14%</strong>]{style="color: #008000;"}
...
1.  [Pour la tranche 1 : de 0 à 6 011 € donc 6 011 \* 0 = 0]{style="color: #008000;"}
2.  [Pour la tranche 2 : de 6 011 à 11 991 € soit 5 980 € (11 991-6 011) x 0.055 = 329 €]{style="color: #008000;"}
3.  [Pour la tranche 3 : de 11 991 à 12 672 € (pas 26 631 € car quotient familial égal à 18 000 €) soit (12 672-11 991) x 0.14 = 95 €]{style="color: #008000;"}
4.  [Pour la tranche 4 : le quotient familial de l'exemple ne va pas jusqu'à cette 4ème tranche (12 672 € \< 26 631).]{style="color: #008000;"}
...
<strong><span style="color: #008000;">impôt brut de Pierre = (0 + 329 + 95)\*1 = 424 €</span></strong>

</p>

<p style="text-align: left;">

[De même pour les deux autres, Paul dans la tranche 3 = (16200-11991)*0.14 = 589 € et Jacques dans la tranche 3 = (21600-11991)*0.14 = 1345 €, donc :]{style="color: #008000;"}

</p>

<p style="text-align: center;">

<strong><span style="color: #008000;">impôt brut de Paul = (0 + 329 + 589)\*1 = 918 €</span></strong>

</p>

<p style="text-align: center;">

<strong><span style="color: #008000;">impôt brut de Jacques = (0 + 329 + 1345)\*1 = 1674 €</span></strong>
...
[<strong>decote = (1016 - impôt brut)/2</strong>]{style="color: #ff6600;"}
...
<strong>[decote de Pierre = (1016 - 424)/2 = 296 €]{style="color: #008000;"}</strong>

</p>

<p style="text-align: center;">

<strong>[decote de Paul = (1016 - 918)/2 = 49 €]{style="color: #008000;"}</strong>

</p>

<p style="text-align: center;">

<strong>[Pas de décote pour Jacques car impôt brut = 1647 € \> 1016 €]{style="color: #008000;"}</strong>
...
<strong>[impôt net de Pierre = 424 - 296 = 128 €]{style="color: #008000;"}</strong>

</p>

<p style="text-align: center;">

<strong>[impôt net de Paul = 918 - 49 = 869 €]{style="color: #008000;"}</strong>

</p>

<p style="text-align: center;">

<strong>[impôt net de Jacques = 1674 €]{style="color: #008000;"}</strong>
...
![](images/variations-impots-valide.png)
...
-   [**Jusqu'à un salaire mensuel net imposable** ]{style="line-height: 15px;"}[**\<**]{style="color: #ff00ff;"} **[1116 €  --\> pas d'impôt à payer]{style="color: #ff00ff;"}**
    -   **De 0 € à 556 € --\> [TMI à 0%]{style="color: #008000;"}**
    -   **De 556 € à 1110 € --\> [TMI à 5,5%]{style="color: #008000;"}**
    -   **De 1110 € à 2465 € --\> [TMI à 14%]{style="color: #008000;"}**
    -   **De 2465 € à 6610 € --\> [TMI à 30%]{style="color: #008000;"}**
    -   **A partir de 1564 € --\> [décote nulle]{style="color: #0000ff;"}**
...
D'après l'article 157 bis du code des impôts[^2], si le **Revenu Net Global est inférieur à 14 630 €** alors on applique un [<strong>abattement de 2332 €</strong>]{style="color: #ff0000;"}, et s'il est **compris entre 14 630 € et 23 580 €** on applique un [<strong>abattement de 1166 €</strong>]{style="color: #ff0000;"}.
...
[Exemple]{style="text-decoration: underline;"} : A l'étape n°2 on rappelle que le Revenu Net Global de Pierre, Paul, Jacques est respectivement 12672 €, 16200€ et 21600€. Pierre a un Revenu Net Global inférieur à 14630 €, il bénéficiera donc d'un abattement spécial du à son invalidité de 2332 €. Tandis que ses compères dont le Revenu Net Global se situe entre 14630 € et 23580€ bénéficieront d'un abattement de 1166 €.

<p style="text-align: center;">

[<strong>revenu net global de Pierre = 12672 - 2332 = 10 340 €</strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

[<strong>revenu net global imposable de Paul = 16200 - 1166 = 15 034 €</strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

[<strong>revenu net global imposable de Jacques =  21600 - 1166 = 20 434 €</strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

![](images/abattements-spec.png)
...
[<strong><strong>Quotient familial de Pierre = 10340/1,5 = 6893 €</strong></strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

[<strong><strong><strong>Quotient familial de Paul = 15034/1,5 = 10 022 €</strong></strong> </strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

[<strong>Quotient familial de Jacques = 20434/1,5 = 13 622 €</strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

![](images/nombre-parts.png)
...
[Pierre : (6011-0)*0%+(6893-6011)*5,5% = 48 €]{style="color: #008000;"}

</p>

<p style="text-align: center;">

[Paul : (6011-0)*0%+(10022-6011)*5,5% = 220 €]{style="color: #008000;"}

</p>

<p style="text-align: center;">

<span style="color: #008000;">Jacques : (6011-0)*0%+(11991-6011)*5,5%+(13622-11991)\*14% = 557 €</span>
...
<strong><span style="color: #008000;">impôt brut de Pierre = 48\*1,5 = 73 €</span></strong>

</p>

<p style="text-align: center;">

<strong><span style="color: #008000;">impôt brut de Paul = 220\*1,5 = 331 €</span></strong>

</p>

<p style="text-align: center;">

<strong><span style="color: #008000;">impôt brut de Jacques = 557\*1,5 = 836 €</span></strong>
...
<strong><strong>[décote de Pierre = (1016-73)/2 = 471 €]{style="color: #008000;"}</strong></strong>

</p>

<p style="text-align: center;">

[<strong>décote de Paul = (1016-331)/2 = 342 €</strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

<strong>[décote de Jacques = (1016-836)/2 = 90 €]{style="color: #008000;"}</strong>
...
[<strong>impôt net de Jacques = 836 - 90 = 746 €</strong>]{style="color: #008000;"}

</p>

<p style="text-align: center;">

![](images/droits-simples-decote.png)
...
En effet, les deux points précédents : existence d'un abattement spécial + demi part supplémentaire pour une personne invalide, procurent une baisse du quotient familial et donc de l'impôt brut par rapport au calcul effectué sur les mêmes revenus d'une personne valide. Toutefois afin de limiter les effets de ces avantages, la **différence d'impôt** entre ces deux modes de calcul est [**plafonné à 1500 €**]{style="color: #ff0000;"} :

<p style="text-align: center;">

[<strong>impôt brut d'une personne valide - impôt brut d'une personne invalide \< 1500 €</strong>]{style="color: #ff6600;"}
...
<strong>B = impôt brut calculé dans le cas valide - 1500 €</strong>
...
[Pierre : impôt brut invalide = 73 €, impôt brut valide = 424 € --\> 424-73 \< 1500 \[OK\]]{style="color: #008000;"}\
[Paul : impôt brut invalide = 331 €, impôt brut valide = 918 € --\> 918-331 \< 1500 \[OK\]]{style="color: #008000;"}\
[Jacques : impôt brut invalide = 836 €, impôt brut valide= 1674 € --\> 1674-836\<1500 \[OK\]]{style="color: #008000;"}
...
<strong>Attention</strong> : ceci est valable plus généralement pour tout calcul avantageux lié à des demi parts supplémentaires, et le plafond correspond à [1500 € par demi parts supplémentaires]{style="text-decoration: underline;"}. Cependant <strong>dans le cas de l'invalidité,</strong> <strong>ce plafond est réévalué à 1497 € de plus</strong> ! C'est ce qu'on appelle une <strong>réduction d'impôt complémentaire</strong>.[^5] Plus précisément :
...
[<strong>Si B-A \> 1497 alors impôt brut retenu = B - 1497 = impôt brut valide - 2997 €</strong>]{style="color: #ff0000;"}

</p>

<p style="text-align: left;">

<strong>Courbe d'imposition d'une personne célibataire invalide</strong>

</p>

<p style="text-align: left;">

![](images/courbe-imposition-invalide.png)
...
![](images/variations-impots-invalide.png)
...
![](images/comparaison-invalide-ou-non-2.png)
...
![](images/comparaison-invalide-ou-non.png)
...
[*Sortie*]{style="text-decoration: underline;"} *: Renvoie l'impôt mensuel.*

[Exemple]{style="text-decoration: underline;"} : Pour le salaire de Jacques invalide qui gagne 2000 € net imposable par mois

<p style="text-align: left;">

![](images/imposition-matlab.png)
...
[*Sortie*]{style="text-decoration: underline;"} *: Affiche la courbe d'imposition d'une personne valide ou invalide*
...
[*Sortie*]{style="text-decoration: underline;"} *: Affiche sur le même graphique les courbes d'imposition valide et invalide*
