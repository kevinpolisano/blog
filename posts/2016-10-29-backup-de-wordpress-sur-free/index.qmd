...
Rendez à l'adresse suivante (anciennement sql.free.fr) : [http://phpmyadmin.free.fr/phpMyAdmin/](http://phpmyadmin.free.fr/phpMyAdmin/) puis cliquez sur l'onglet `Exporter`, ce qui vous permet d'afficher dans le navigateur les instructions SQL, qu'il vous suffit de copier-coller dans un fichier texte.
